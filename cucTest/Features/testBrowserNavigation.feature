...
Feature: Test Navigation Flow
  ...
  Scenario: Registration
   ...
   Given "D3" I enter text "rajbazar20@gmail.com" on web-"email" element
   Given "D3" I enter text "447884443280" on web-"imsi" element
   Given "D3" I enter text "447884443280" on web-"accessNum" element
   Then "D3" I web-wait for "2" seconds
   Given "D3" I select the web-"billingCycle"
   Then "D3" I web-wait for "2" seconds
   Given "D3" I enter text "Raj20" on web-"username" element
  ...
  Scenario: Delete Subscriber 
   Given "D3" I click on web-"showSettings" element
    Given "D3" I click on web-"delete" element
    Then "D3" I web-wait for "1" seconds
    Given "D3" I click on web-"okButton" element
